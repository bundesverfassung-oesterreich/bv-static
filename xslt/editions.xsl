                        ...
                        <div class="wp-transcript">
                            <div class="row" id="edition_metadata">
                                ...
                                <div class="row align-items-start justify-content-start">
                                    <div class="edition_metadata_button" role="button">
                                        <a href="{$target_xml}/{$doc_id}.xml">
                                            XML <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                ...
                                <div class="edition_metadata_button" role="button">
                                    ...
                                    <a href="no_data.html">
                                            PDF <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                        <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"/>
                                        <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"/>
                                    </svg>
                                </a>
                                ...
                                <div class="image_rights">
                                    <div class="row">
                                        ...
                                        <button class="osd_nav_element" id="osd_zoom_reset_button">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="2.5rem" width="auto" viewBox="0 0 384 512">                                                <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                    ...
                                    <p>Das Original befindet sich im Eigentum des Österreichischen Staatsarchivs unter der <span style="font-weight: bold;">ÖStA-Signatur „<xsl:value-of select='//tei:msDesc/tei:msIdentifier/tei:idno[@type="archive"]/text()[1]/normalize-space()'/>
“.</span> Die Verwendung des Digitalisats durch Dritte bedarf einer schriftlichen Bewilligung des ÖStA entsprechend der geltenden Benutzungsordnung.</p>
                            </div>
                        </div>
                    </div>
