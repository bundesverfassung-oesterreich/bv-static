...
try:
    client.collections["B-VG 1920"].delete()
...
for x in tqdm(files, total=len(files)):
    ...
    for v in facs:
        ...
        cfts_record["resolver"] = f"https://github.com/bundesverfassung-oesterreich/bv-static-v1/{record['id']}"
...
print(make_index)
print("done with indexing B-VG 1920")

make_index = CFTS_COLLECTION.documents.import_(cfts_records, {"action": "upsert"})
print(make_index)
print("done with cfts-index B-VG 1920")
